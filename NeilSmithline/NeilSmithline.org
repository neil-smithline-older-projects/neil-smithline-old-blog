...
#+HTML: <br/> 
#+HTML:  (The newest revision of this resume is available at
#+HTML: <br/> 
#+HTML:  <a href="http://www.neilsmithline.com/NeilSmithline.html" title="My Homepage" target="_blank">NeilSmithline.com/NeilSmithline.html</a>)
#+HTML: <br/>
#+HTML:  831 Beacon St, Suite #255
#+HTML: <br/>
#+HTML:  Newton Centre, MA 02459
#+HTML: <br/>
#+HTML: <a href="http://www.neilsmithline.com" title="My Homepage" target="_blank"> www.NeilSmithline.com</a>
#+HTML:<br/>
#+HTML:  Fax: 206-666-5090&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Voice: 781-754-7628
#+HTML:<br/>
#+END_CENTER
